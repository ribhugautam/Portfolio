...
async function page({ params }: { params: { id: number} }) {
  ...
  const filteredProject = project.filter((project: { id: number} ) => project.id == id);
  return (
        ...
        <div className="pt-28 mx-auto sm:pt-36 lg:pt-32">
          <section className="flex flex-col p-6 justify-center items-center gap-12">
            <div className="relative w-full">
              <Link href="/projects" className="text-4xl mt- flex justify-center items-center text-violet-600 absolute left-0 ">
                <MdArrowBackIosNew /> 
              </Link>
