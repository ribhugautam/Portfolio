                ...
                <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-300">
                  ...
                  >
                    ...
                    <p className="mt-3 text-xl font-semibold ">
                      As a Full Stack Trainee, I gained hands-on experience with
                      the MERN stack, mastering MongoDB, Express.js, React, and
                      Node.js. This training equipped me with the skills to
                  ...
                  >
                    ...
                    <p className="mt-3 text-xl font-semibold">
                      As a Front End Developer Intern at Tipzy, I contributed to
                      the development of three web applications, enhancing my
                      skills in creating user-friendly interfaces. This
                  ...
                  >
                    ...
                    <p className="mt-3 text-xl font-semibold">
                      I was promoted to Full Stack Developer at Tipzy after my
                      internship, where I expanded my skills to encompass both
                      front-end and back-end development. In this role, I
                      contributed to building and optimizing web applications,
          ...
          <div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
            ...
            >
              <svg
                ...
                viewBox="0 0 32 32"
                aria-label="Angular"
                className="w-12 h-12 transition-all duration-200 ease-linear animate-glitch hover:animate-none mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-600"
              >
                <title>Angular</title>
              ...
              <svg
                ...
                viewBox="0 0 32 32"
                aria-label="Gatsby"
                className="w-12 h-12 mx-10 my-6 transition-all duration-200 ease-linear animate-glitch hover:animate-none fill-current md:mx-12 lg:m-0 dark:text-gray-600"
              >
                <title>Gatsby</title>
